...
class customer:
    def __init__(self,root):
        ...
        btn_frame.place(x=0,y=450,width=425,height=40)
        ...
        btnUpdate=Button(btn_frame,text="Update",width=8,font=("times new roman",11,"bold"),bg="black",fg="gold").grid(row=0,column=1,padx=1)

        btnDelete=Button(btn_frame,text="Delete",width=8,font=("times new roman",11,"bold"),bg="black",fg="gold").grid(row=0,column=2,padx=1)

        btnClear=Button(btn_frame,text="Clear",width=8,font=("times new roman",11,"bold"),bg="black",fg="gold").grid(row=0,column=3,padx=1)
